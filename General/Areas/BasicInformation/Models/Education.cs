...
namespace General.Areas.BasicInformation.Models
{
    public class Education
    {
        ...
        [DisplayName("نام مدرک"), TypeConverter("NvarChar(50)"), StringLength(50, ErrorMessage = "کاربرگرامی طول فيلد [ {0} ] 50 کاراکتر است"), Required(ErrorMessage = "كاربر گرامي ، لطفاً فیلد [ {0} ] را وارد نماييد")]
