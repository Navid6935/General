    ...
    )
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string strAddress = General.Helpers.Utilities.ApplicationEdit.GetValue("NoReplyAddress");
                    string strDisplayName = General.Helpers.Utilities.ApplicationEdit.GetValue("NoReplyDisplayName");
                ...
                if (recipients == null)
                {
                    ...
                    //ایجاد دو رشته از نیم اسپیس وب اپلیکیشن و کلاس اپلیکیشن ادیت و متد گت ولیو
                    string strAddress = General.Helpers.Utilities.ApplicationEdit.GetValue("SupportAddress");
                    string strDisplayName = General.Helpers.Utilities.ApplicationEdit.GetValue("SupportDisplayName");
                ...
                string strBccAddresses = General.Helpers.Utilities.ApplicationEdit.GetValue("BccAddresses");

                //اگر  استرینگ بی سی سی نال بود
                if (string.IsNullOrEmpty(strBccAddresses))
                {
                    //پراپرتی بی سی سی را به شی میل مسیج اد میکنیم
                    oMailMessage.Bcc.Add("navid.shatel@gmail.com");
                }
                //در غیراینصورت
                else
                {
                ...
                //ایجاد یک رشته از نیم اسپیس وب اپلیکیشن و کلاس اپلیکیشن ادیت و متد گت ولیو
                string strEmailSubjectPrefix = General.Helpers.Utilities.ApplicationEdit.GetValue("EmailSubjectPrefix");
                ...
                oMailMessage.Headers.Add("PMN_Mailer_Version", "1.2.1");
                oMailMessage.Headers.Add("PMN_Mailer_Date", "2019/12/12");
                oMailMessage.Headers.Add("PMN_Mailer_Author", "Mohsen Dadkhah");
                oMailMessage.Headers.Add("PMN_Mailer_Company", "www.ppbm.ir:8880");
                ...
                if (General.Helpers.Utilities.ApplicationEdit.GetValue("SmtpClientEnableSsl", "0") == "1")
                {
                ...
                oSmtpClient.Timeout =
                    System.Convert.ToInt32(General.Helpers.Utilities.ApplicationEdit.GetValue("SmtpClientTimeout", "100000"));
