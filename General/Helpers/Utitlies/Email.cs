...
namespace General.Helpers.Utilities
{
    public static class Email
    {
        ...
        public static void SendEmailAfterRegistration
            (string insurance,string eMail,string userName, string password, string code)
        {
        ...
        public static void Sendcode(string userId,string eMail,string userName, string code)
        {
            SendEmailAfterRegistration(userId,eMail,userName,"", code);
        }
